...
export type DestinationTransport = "None" | "Rental Car" | "Rental Van";
...
export type GrindingScope = {
  ...
  productionTravelMode: TravelMode;
  productionOneWayKm: number;
  productionSecondaryOneWayKm: number;
  productionVehicles: number;
  productionReturnFlights: number;
  productionAirportTransport: AirportTransport;
  productionAirportTransferReturns: number;
  productionAirportParkingDays: number;
  productionDestinationTransport: DestinationTransport;
  productionRentalVehicles: number;
  productionRentalVehicleDays: number;
  ...
  surveyorTravelMode: TravelMode;
  surveyorOneWayKm: number;
  surveyorSecondaryOneWayKm: number;
  surveyorVehicles: number;
  surveyorReturnFlights: number;
  surveyorAirportTransport: AirportTransport;
  surveyorAirportTransferReturns: number;
  surveyorAirportParkingDays: number;
  surveyorDestinationTransport: DestinationTransport;
  surveyorRentalVehicles: number;
  surveyorRentalVehicleDays: number;
...
export type ScreedScope = {
  ...
  primerRate: number;
  primerMargin: number;
  primerContingency: number;
  primerWaste: number;
  sandBags: number;
  sandRate: number;
  sandMargin: number;
  sandContingency: number;
  sandWaste: number;
...
export type RepairsScope = {
  ...
  mobilisationSecondaryOneWayKm: number;
...
export type AdminRates = {
  ...
  grindingSurveyorDayRate: number;
  grindingSurveyorTravelDayRate: number;
  ...
  screedHotelNightRate: number;
  screedEngineeringReportRate: number;
  ...
  screedMaterialBagRate: number;
  screedPrimerUnitRate: number;
  screedSandBagRate: number;
  screedMaterialContingency: number;
  screedMaterialWaste: number;
  screedPrimerContingency: number;
  screedPrimerWaste: number;
  screedSandContingency: number;
  screedSandWaste: number;
