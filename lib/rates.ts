...
export const emptyInput: ProjectInput = {
  ...
  grinding: {
    ...
    productionSubcontractors: [{ name: "Grinding subcontractor", priceType: "lump sum", rate: 0, days: 0, margin: 0.3, mobilisationCost: 0, mobilisations: 0, mobilisationMargin: 0.3, standbyDays: 0, standbyRate: 0, standbyMargin: 0.3, weekendUpliftDays: null, weekendUpliftRate: 0, weekendUpliftMargin: 0.3 }],
    ...
    surveyorSubcontractors: [{ name: "Grinding surveyor subcontractor", priceType: "lump sum", rate: 0, days: 0, margin: 0.3, mobilisationCost: 0, mobilisations: 0, mobilisationMargin: 0.3, standbyDays: 0, standbyRate: 0, standbyMargin: 0.3, weekendUpliftDays: null, weekendUpliftRate: 0, weekendUpliftMargin: 0.3 }],
    weeks: 1,
    daysPerWeek: 5,
    surveyorsOnSite: 0,
    grindersOnSite: 0,
  ...
  screeding: {
    ...
    surveyorRentalVehicles: 0,
    surveyorRentalVehicleDays: 0,
    surveyorSubcontractors: [{ name: "Screed surveyor subcontractor", priceType: "lump sum", rate: 0, days: 0, margin: 0.3, mobilisationCost: 0, mobilisations: 0, mobilisationMargin: 0.3, standbyDays: 0, standbyRate: 0, standbyMargin: 0.3, weekendUpliftDays: null, weekendUpliftRate: 0, weekendUpliftMargin: 0.3 }],
    hotelRequired: false,
    vanRentalRequired: false,
    ...
    screedMaterialContingency: 0,
    screedMaterialWaste: 0,
    screedToppingUnits: 0,
    screedToppingRate: 0,
    screedToppingMargin: 0.2,
    screedToppingContingency: 0,
    screedToppingWaste: 0,
    primerUnits: 0,
    primerRate: 0,
    primerMargin: 0.2,
    primerContingency: 0,
  ...
  repairs: {
    ...
    pmSubsistenceDays: 0,
    pmFuelKm: 0,
    repairSubcontractors: [{ name: "Repair subcontractor", priceType: "lump sum", rate: 0, days: 0, margin: 0.3, mobilisationCost: 0, mobilisations: 0, mobilisationMargin: 0.3, standbyDays: 0, standbyRate: 0, standbyMargin: 0.3, weekendUpliftDays: null, weekendUpliftRate: 0, weekendUpliftMargin: 0.3 }],
